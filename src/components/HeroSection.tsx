...
const HeroSection = () => {
 ...
 <div className="w-16 h-16 md:w-24 md:h-24 lg:w-28 lg:h-28 bg-white rounded-full xs:ml-[-14rem] sm:ml-[-20rem] md:ml-[18rem] lg:ml-[25rem] mt-6 md:mt-[5rem] shadow-2xl absolute flex justify-center items-center" >
     <img src="/logoImage/react.png" className="w-12 h-12 md:w-16 md:h-16 lg:w-20 lg:h-20"/>
     </div>
     ...
     <div className="w-16 h-16 md:w-24 md:h-24 lg:w-28 lg:h-28 bg-white rounded-full xs:-ml-56 sm:ml-[-19rem] md:ml-[18rem] lg:ml-[24rem] shadow-2xl mt-48 md:mt-[-2.4rem] lg:mt-[-3rem] flex justify-center items-center" >
     <img src="/logoImage/redux.png" className="w-10 h-10 md:w-16 md:h-16 lg:w-20 lg:h-20 "/>
     </div> 
     <div className="w-10 h-10 md:w-14 md:h-14 lg:w-16 lg:h-16 bg-gradient-to-r from-blue-900 to-white rounded-full absolute xs:ml-[21rem] sm:ml-[26rem] mt-52 md:mt-14 md:ml-[23rem]  lg:mt-6 lg:ml-[42rem] shadow-2xl" />
     </div> 
