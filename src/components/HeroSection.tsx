...
const HeroSection = () => {
  return (
    ...
    <div className="w-full bg-green-500 md:w-[44%] relative">
    ...
    <div className="relative w-full md:w-[56%] bg-red-900 text-black xs:flex xs:justify-center md:block">

    <div className="w-20 h-20 md:w-64 md:h-64 lg:w-80 lg:h-80 bg-gradient-to-r from-green-900 to-white rounded-full ml-[26rem] md:ml-[26rem]   lg:ml-[44rem] shadow-2xl absolute" />
 <div className="w-16 h-16 md:w-24 md:h-24 lg:w-28 lg:h-28 bg-white rounded-full ml-[-18rem] md:ml-[18rem] lg:ml-[25rem] mt-6 md:mt-[5rem] shadow-2xl absolute flex justify-center items-center" >
     <img src="/logoImage/react.png" className="w-6 h-6 md:w-16 md:h-16 lg:w-20 lg:h-20"/>
     </div>
       <div className="w-16 h-16 md:w-24 md:h-24 lg:w-28 lg:h-28 bg-white rounded-full ml-[-19rem] md:ml-[20.6rem] lg:ml-[28rem] mt-28 md:mt-[13rem] lg:mt-[16rem] shadow-2xl absolute">
       <img src="/logoImage/js.png" className="w-14 h-14 md:w-24 md:h-24 lg:w-24 lg:h-24 md:pr-3 lg:pr-0 md:mt-[-0.8rem] lg:mt-[-0.6rem]"/>
       </div>
     <div className="w-60 h-60 md:w-72 md:h-72 lg:w-96 lg:h-96 bg-gradient-to-r from-green-100 to-white rounded-full  shadow-2xl mt-[1rem] md:mt-28 absolute md:relative">
     <img src="/Image/my1.png" className="md:w-[22rem] lg:w-[24rem]  h-auto absolute ml-6 " />
     </div>
     <div className="w-16 h-16 md:w-24 md:h-24 lg:w-28 lg:h-28 bg-white rounded-full -ml-64 md:ml-[18rem] lg:ml-[24rem] shadow-2xl mt-48 md:mt-[-2.4rem] lg:mt-[-3rem] flex justify-center items-center" >
     <img src="/logoImage/redux.png" className="w-12 h-12 md:w-16 md:h-16 lg:w-20 lg:h-20 "/>
     </div> 
     <div className="w-10 h-10 md:w-14 md:h-14 lg:w-16 lg:h-16 bg-gradient-to-r from-blue-900 to-white rounded-full absolute ml-[26rem] mt-52 md:mt-14 md:ml-[23rem]  lg:mt-6 lg:ml-[42rem] shadow-2xl" />
     </div> 
