...
const HeroSection = () => {
  return (
    ...
    <div className="w-1/2 relative">
      ...
      <div className="w-28 h-28 bg-backColor rounded-full ml-[36rem] shadow-xl" />
      ...
      <div className="w-8 h-8 bg-backColor rounded-full ml-[28rem] mt-32 shadow-lg" />
    </div>

    {/* Right Section with content */}
    <div className="w-1/2 relative">
    <div className="w-80 h-80 bg-backColor rounded-full mt-[-12rem] ml-[38rem] shadow-2xl absolute" />
    <div className="w-28 h-28 bg-backColor rounded-full ml-[25rem] mt-[5rem] shadow-2xl absolute" />
    ...
    <img src="/myPhoto.png"  className="max-w-64 h-auto absolute ml-10"  />
    </div>
    <div className="w-28 h-28 bg-backColor rounded-full ml-[24rem] shadow-2xl mt-[-3rem]" />
